...
// function convertDate(testing) {
//   let datee = new Date()
//   let month = datee.getMonth()
//   let day = dayy.getDay()
//   const dayL = ["Minggu", "Senin", "Selasa","Rabu","Kamis","Jumat","Sabtu"]
//   const bulanS = ["Jan","Feb","Mar","Apr","Mei","Jun","Jul","Agus","Sept","Okt","Nov","Des"]
//   const bulan = datee.getMonth()
//   const hari = dayy.getDay()
